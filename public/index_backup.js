...
{
  /*alert("entered save data function");
  alert(transactionData.name);
  console.log(transactionData.name);
  alert(transactionData.value);*/
  const request = window.indexedDB.open("toDoList", 1);
      ...
      request.onsuccess = () => {
        ...
        toDoListStore.add({ listID: transactionData.name, status: transactionData });
      }
}